...
const PreviousYear = () => {
  ...
  const fetchFiles = async () => {
    try {
      const response = await getFiles('previous-year')
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      >
        <h2 className="text-xl font-semibold mb-4">Available Question Papers</h2>
        
        {files.length === 0 ? (
          <p className="text-muted-foreground text-center py-8">
            No question papers available yet. Upload some PDFs to get started!
          </p>
        ) : (
